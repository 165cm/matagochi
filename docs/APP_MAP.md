...
| 役割 | 最初になる人 | できること |
| --- | --- | --- |
| 決める人（owner） | 招待リンクをつくった人 | すべて。相手の役割を切り替える、「◯◯に食べたいものを聞く」、日付つきリクエストを「入れ替える」 |
| 見るだけ（viewer） | 招待されて参加した人 | 全タブを見る、🙋食べたい、各日の「🙋 別のがいい」、買い物のチェック、🔖保存、作った記録・評価（6択すべて） |
| 変えられる（editor） | 決める人がONにした人／役割がない以前の家庭 | 決める人と同じ（役割の切り替えを除く） |

- 見るだけモードの献立タブには「買い物の前に、食べたいものを送ってね」を出し、決定後は「今回の献立は決まりました」に変わる
- 役割のない以前の家庭は、設定の「献立を決めるのは◯◯にする」で決める人を設定できる
