const CACHE_NAME = "ripigochi-v46";
...
const CORE_ASSETS = [
  ...
  "./manifest.webmanifest?v=20260926-clip",
  "./icons/favicon-32.png?v=20260926-clip",
  "./icons/icon-192.png?v=20260926-clip",
  "./icons/icon-512.png?v=20260926-clip",
  "./icons/icon-maskable-512.png?v=20260926-clip",
  "./icons/apple-touch-icon.png?v=20260926-clip"
];
