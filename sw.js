const CACHE_NAME = "ripigochi-v43";
...
const CORE_ASSETS = [
  ...
  "./manifest.webmanifest?v=20260926-fetchfix",
  "./icons/favicon-32.png?v=20260926-fetchfix",
  "./icons/icon-192.png?v=20260926-fetchfix",
  "./icons/icon-512.png?v=20260926-fetchfix",
  "./icons/icon-maskable-512.png?v=20260926-fetchfix",
  "./icons/apple-touch-icon.png?v=20260926-fetchfix"
];
