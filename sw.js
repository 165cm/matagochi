const CACHE_NAME = "ripigochi-v41";
const APP_VERSION = "20260926-paste";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./manifest.webmanifest?v=20260926-paste",
  "./icons/favicon-32.png?v=20260926-paste",
  "./icons/icon-192.png?v=20260926-paste",
  "./icons/icon-512.png?v=20260926-paste",
  "./icons/icon-maskable-512.png?v=20260926-paste",
  "./icons/apple-touch-icon.png?v=20260926-paste"
];
