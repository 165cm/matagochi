const CACHE_NAME = "ripigochi-v39";
const APP_VERSION = "20260926-appbar";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./manifest.webmanifest?v=20260926-appbar",
  "./icons/favicon-32.png?v=20260926-appbar",
  "./icons/icon-192.png?v=20260926-appbar",
  "./icons/icon-512.png?v=20260926-appbar",
  "./icons/icon-maskable-512.png?v=20260926-appbar",
  "./icons/apple-touch-icon.png?v=20260926-appbar"
];
