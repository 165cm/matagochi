const CACHE_NAME = "ripigochi-v42";
const APP_VERSION = "20260926-register";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./manifest.webmanifest?v=20260926-register",
  "./icons/favicon-32.png?v=20260926-register",
  "./icons/icon-192.png?v=20260926-register",
  "./icons/icon-512.png?v=20260926-register",
  "./icons/icon-maskable-512.png?v=20260926-register",
  "./icons/apple-touch-icon.png?v=20260926-register"
];
