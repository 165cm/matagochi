const CACHE_NAME = "ripigochi-v50";
...
const CORE_ASSETS = [
  ...
  "./manifest.webmanifest?v=20260926-reread",
  "./icons/favicon-32.png?v=20260926-reread",
  "./icons/icon-192.png?v=20260926-reread",
  "./icons/icon-512.png?v=20260926-reread",
  "./icons/icon-maskable-512.png?v=20260926-reread",
  "./icons/apple-touch-icon.png?v=20260926-reread"
];
