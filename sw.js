const CACHE_NAME = "ripigochi-v25";
const APP_VERSION = "20260925-round";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./manifest.webmanifest?v=20260925-round",
  "./icons/favicon-32.png?v=20260925-round",
  "./icons/icon-192.png?v=20260925-round",
  "./icons/icon-512.png?v=20260925-round",
  "./icons/icon-maskable-512.png?v=20260925-round",
  "./icons/apple-touch-icon.png?v=20260925-round"
];
