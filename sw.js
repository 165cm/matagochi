const CACHE_NAME = "ripigochi-v38";
const APP_VERSION = "20260926-pantry";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./manifest.webmanifest?v=20260926-pantry",
  "./icons/favicon-32.png?v=20260926-pantry",
  "./icons/icon-192.png?v=20260926-pantry",
  "./icons/icon-512.png?v=20260926-pantry",
  "./icons/icon-maskable-512.png?v=20260926-pantry",
  "./icons/apple-touch-icon.png?v=20260926-pantry"
];
