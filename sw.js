const CACHE_NAME = "ripigochi-v40";
const APP_VERSION = "20260926-tags";
const CORE_ASSETS = [
  "./",
  "./index.html",
  ...
  "./manifest.webmanifest?v=20260926-tags",
  "./icons/favicon-32.png?v=20260926-tags",
  "./icons/icon-192.png?v=20260926-tags",
  "./icons/icon-512.png?v=20260926-tags",
  "./icons/icon-maskable-512.png?v=20260926-tags",
  "./icons/apple-touch-icon.png?v=20260926-tags"
];
